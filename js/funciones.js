...
function onMenuKeyDown()
{
	$('#menu_flotante').html(
				...
				'if(getLocalStorage("premium")==FLAG_PREMIUM || getLocalStorage("premium")==FLAG_PREMIUMPLUS) {'+
					...
					'</div></a>\'); }'+
				'</script>'+				
				'<span id="ajustes_flot"> </span>'+
				'<script>'+
				'if(getLocalStorage("premium")==FLAG_PREMIUM || getLocalStorage("premium")==FLAG_PREMIUMPLUS) {'+
					'$("#ajustes_flot").html(\'<a href="ajustes.html"><div class="button_float_nav">'+
			...
			case "lecturas": 	
					...
					if(type=="mes")
					{
						...
						$('#calendario').datepicker({
											...
											defaultDate:new Date(fecha_calendario[1]+"-"+(parseInt(fecha_calendario[2])+1)+"-"+fecha_calendario[0]),
